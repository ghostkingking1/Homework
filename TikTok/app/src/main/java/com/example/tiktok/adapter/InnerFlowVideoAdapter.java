 ...
 */
public class InnerFlowVideoAdapter extends ListAdapter<VideoInfo, InnerFlowVideoAdapter.ViewHolder> {
    // 内流ViewModel（处理视频播放/业务逻辑）
    private final InnerFlowViewModel mViewModel;

    public InnerFlowVideoAdapter(InnerFlowViewModel viewModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // 绑定内流视频Item布局
        ItemInnerFlowBinding binding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.getContext()),
                R.layout.item_inner_flow,
                parent,
                false
        );
        // 关联ViewModel到布局
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemInnerFlowBinding binding;

        public ViewHolder(ItemInnerFlowBinding binding) {
